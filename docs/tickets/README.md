...
| EM-019-001 | active | critical | A reported figure is read from a command, not written by its author |
| EM-019-001-001 | ready | standard | Rule-adding tickets produce no decision record, against the trigger list |
